...
write_xlsx(as.data.frame(peak_ppa_frame), path = peak_ppa_frame_dir)
...
write_xlsx(as.data.frame(cell_tf_snp), path = peak_ratio_frame_dir)
...
print("Directly mapped and cicero genes identified!")
