...
6. All genes in inputs provided to this pipeline (e.g., scRNA-seq, eQTL datasets) should be present as gene names (e.g., *TBXT*) and not ENSEMBL gene IDs (e.g., ENSG00000164458).
7.	Please see below explanation of mandatory RegSCOUT parameter (must always be specified):
...
8.  Please see below explanations of important terms used in this README:
